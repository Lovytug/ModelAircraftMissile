...
#include "../../../../../../../rocket/composite_compute_component/homing_system/steering_system/steering_system/ISteeringSystemComputation.h"

#include "../../../../../../../rocket/simple_component/homing_system/steering system/ISteeringSystem.h"
...
[[nodiscard]] u_ptr<mdt::DynamicBundle> phis::MySteeringSystemComputationRealisticPhisics::getDynamicBundle() const
{
	...
	bundle->add<detail::IComputeModule::DynamicType, const detail::IComputeModule&, double>(
		"steering_system_func",
		[this](const detail::IComputeModule& computer, double cmd) -> detail::IComputeModule::DynamicType {
