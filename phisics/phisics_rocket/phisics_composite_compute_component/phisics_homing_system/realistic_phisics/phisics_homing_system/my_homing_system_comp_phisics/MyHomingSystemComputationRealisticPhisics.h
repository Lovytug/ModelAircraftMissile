...
#include <any>
#include "../IHomingSystemComputationRealisticPhisics.h"

namespace phis
{
	struct HomingSystemComputationDynamicBundle final : public mdt::DynamicBundle
	{
	...
	class MyHomingSystemComputationRealisticPhisics final : public IHomingSystemComputationRealisticPhisics
	{
	public:
		explicit MyHomingSystemComputationRealisticPhisics();
