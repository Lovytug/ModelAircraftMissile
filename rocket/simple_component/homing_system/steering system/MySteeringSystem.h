...
namespace steer
{
	...
	struct MySteeringSystemDynamicData final : public detail::IComponent::DynamicType
	{
	...
	template<typename IFace = ISteeringSystem>
	struct MySteeringSystemStaticData final : public detail::IComponent::StaticType
	{
	...
	class MySteeringSystem final : public ISteeringSystem
	{
	public:
